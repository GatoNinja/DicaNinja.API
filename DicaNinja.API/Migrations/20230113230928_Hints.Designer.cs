...
namespace DicaNinja.API.Migrations
{
    ...
    [Migration("20230113230928_Hints")]
    partial class Hints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DicaNinja.API.Models.Hint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("BookId")
                        .HasDatabaseName("ix_hints_book_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_hints_user_id");
            ...
            modelBuilder.Entity("DicaNinja.API.Models.Hint", b =>
                {
                    b.HasOne("DicaNinja.API.Models.Book", "MyProperty")
                        .WithMany("Hints")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_hints_books_book_id");
                    ...
                    b.HasOne("DicaNinja.API.Models.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_hints_users_user_id");
