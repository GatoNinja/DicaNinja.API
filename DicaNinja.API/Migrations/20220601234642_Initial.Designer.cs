...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DicaNinja.API.DDD.Author.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DicaNinja.API.DDD.Book.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DicaNinja.API.DDD.Category.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DicaNinja.API.DDD.Favorite.Favorite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DicaNinja.API.DDD.Identifier.Identifier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DicaNinja.API.DDD.PasswordRecovery.PasswordRecovery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DicaNinja.API.DDD.Person.Person", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DicaNinja.API.DDD.RefreshToken.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DicaNinja.API.DDD.User.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AuthorBook", b =>
                {
                    b.HasOne("DicaNinja.API.DDD.Author.Author", null)
                        .WithMany()
                    ...
                    b.HasOne("DicaNinja.API.DDD.Book.Book", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BookCategory", b =>
                {
                    ...
                    b.HasOne("DicaNinja.API.DDD.Category.Category", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DicaNinja.API.DDD.Favorite.Favorite", b =>
                {
                    b.HasOne("DicaNinja.API.DDD.Book.Book", "Book")
                        .WithMany("Favorites")
                    ...
                    b.HasOne("DicaNinja.API.DDD.User.User", "User")
                        .WithMany("Favorites")
            ...
            modelBuilder.Entity("DicaNinja.API.DDD.PasswordRecovery.PasswordRecovery", b =>
                {
                    b.HasOne("DicaNinja.API.DDD.User.User", "UserModel")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("DicaNinja.API.DDD.Person.Person", b =>
                {
                    b.HasOne("DicaNinja.API.DDD.User.User", "User")
                        .WithOne("PersonModel")
                        .HasForeignKey("DicaNinja.API.DDD.Person.Person", "UserId")
